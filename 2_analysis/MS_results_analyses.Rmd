...
# Demographic Confoundings
model_neg_full_pc1 <- lmer(
  negativity_gpt ~  PC1_score + 
                    word_counts + age + gender + edu + relative_abstractness_gpt + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_neg_full_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated Distress Score',
                            'prompt_stage' = 'Scenario Stage',
...
tbl_regression(model_neg_full_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety',
                            'prompt_stage' = 'Scenario Stage',
...
### Negativity Val Moderation (Others)
```{r neg bias valence mod reg other PCA scores}
# No Demographic Confoundings
model_neg_val_moderate_simple_pc1 <- lmer(
  negativity_gpt ~  PC1_score*prompt_val + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_neg_val_moderate_simple_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated Distress Score',
                            'prompt_val' = 'Scenario Valence',
...
tbl_regression(model_neg_val_moderate_full_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated Distress Score',
                            'prompt_val' = 'Scenario Valence',
...
# No Demographic Confoundings
model_neg_val_moderate_simple_pc3 <- lmer(
  negativity_gpt ~  PC3_score*prompt_val + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_neg_val_moderate_simple_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety',
                            'prompt_val' = 'Scenario Valence',
...
# No Demographic Confoundings
model_neg_val_moderate_full_pc3 <- lmer(
  negativity_gpt ~  PC3_score*prompt_val + 
                    word_counts + age + gender + edu + relative_abstractness_gpt + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_neg_val_moderate_full_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety',
                            'prompt_val' = 'Scenario Valence',
...
### Negativity Stage Moderation (Others)
```{r neg bias stage mod reg other PCA scores}
# No Demographic Confoundings
model_neg_stage_moderate_simple_pc1 <- lmer(
  negativity_gpt ~  PC1_score*prompt_stage + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_neg_stage_moderate_simple_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated Distress Score',
                            'prompt_val' = 'Scenario Valence',
...
tbl_regression(model_neg_stage_moderate_full_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated Distress Score',
                            'prompt_val' = 'Scenario Valence',
...
# No Demographic Confoundings
model_neg_stage_moderate_simple_pc3 <- lmer(
  negativity_gpt ~  PC3_score*prompt_stage + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_neg_stage_moderate_simple_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety',
                            'prompt_val' = 'Scenario Valence',
...
# No Demographic Confoundings
model_neg_stage_moderate_full_pc3 <- lmer(
  negativity_gpt ~  PC3_score*prompt_stage + 
                    word_counts + age + gender + edu + relative_abstractness_gpt + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_neg_stage_moderate_full_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety',
                            'prompt_val' = 'Scenario Valence',
...
### Relative Abstractness Main (Others)
```{r abs main others}

cor.test(confirm_tmp$mean_relative_abstractness, 
         confirm_tmp$activated_distress, method="spearman")
cor.test(confirm_tmp$mean_relative_abstractness, 
         confirm_tmp$non_dep_anxiety, method="spearman")

# PCA Component 1 ~ Negativity
model_abs_simple_pc1 <- lmer(
  relative_abstractness_gpt ~  PC1_score + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_abs_simple_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated General Distress'))

# Including Demographic Confoundings
model_abs_full_pc1 <- lmer(
  relative_abstractness_gpt ~  PC1_score + 
                    word_counts + age + gender + edu + negativity_gpt + 
  (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_abs_full_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated General Distress',
                            'word_counts' = 'Word Counts',
...
# PCA Component 3 ~ Negativity
model_abs_simple_pc3 <- lmer(
  relative_abstractness_gpt ~  PC3_score + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_abs_simple_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety Score'))

# PCA Component 3 ~ Negativity
model_abs_full_pc3 <- lmer(
  relative_abstractness_gpt ~  PC3_score + 
                    word_counts + age + gender + edu + negativity_gpt + 
  (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_abs_full_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety Score',
                            'word_counts' = 'Word Counts',
...
### Relative Abstractness Val Moderation (Others)
```{r abs valence moderation reg others}
# PCA1 Component ~ Negativity*Valence
model_abs_moderate_simple_pc1 <- lmer(
  relative_abstractness_gpt ~  PC1_score*prompt_val + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_abs_moderate_simple_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated General Distress',
                            'prompt_val' = 'Scenario Valence'))

model_abs_moderate_full_pc1 <- lmer(
  relative_abstractness_gpt ~  PC1_score*prompt_val + 
                    word_counts + age + gender + edu + negativity_gpt + 
  (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_abs_moderate_full_pc1,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC1_score' = 'Activated General Distress',
                            'prompt_val' = 'Scenario Valence',
...
# PCA3 Component ~ Negativity*Valence
model_abs_moderate_simple_pc3 <- lmer(
  relative_abstractness_gpt ~  PC3_score*prompt_val + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
)

tbl_regression(model_abs_moderate_simple_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety Score',
                            'prompt_val' = 'Scenario Valence'))

model_abs_moderate_full_pc3 <- lmer(
  relative_abstractness_gpt ~  PC3_score*prompt_val + 
                    word_counts + age + gender + edu + negativity_gpt + 
  (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_abs_moderate_full_pc3,
               pvalue_fun = label_style_pvalue(digits = 3),
               estimate_fun = ~style_sigfig(.x, digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety Score',
                            'prompt_val' = 'Scenario Valence',
...
### Relative Abstractness Stage Moderation (Others)
...
model_abs_stage_moderate_full_pc1 <- lmer(
  relative_abstractness_gpt ~  PC1_score*prompt_stage + 
                        word_counts + age + gender + edu + negativity_gpt + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_abs_stage_moderate_full_pc1,
               estimate_fun = ~style_sigfig(.x, digits = 3),
               pvalue_fun = label_style_pvalue(digits = 3),
               label = list('PC1_score' = 'Activated General Distress Score',
                            'prompt_stage' = 'Scenario Stage',
...
# No Demographic Confoundings
model_abs_stage_moderate_full_pc3 <- lmer(
  relative_abstractness_gpt ~  PC3_score*prompt_stage + 
                        word_counts + age + gender + edu + negativity_gpt + 
    (1 | prolific_id) + (1 | prompt_val_set),
  data = confirm_final
...
tbl_regression(model_abs_stage_moderate_full_pc3,
               estimate_fun = ~style_sigfig(.x, digits = 3),
               pvalue_fun = label_style_pvalue(digits = 3),
               label = list('PC3_score' = 'Non-Depressive Anxiety Score',
                            'prompt_stage' = 'Scenario Stage',
